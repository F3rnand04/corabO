...
// Your web app's Firebase configuration - Reverted to original for stability
...
// Explicitly set the auth domain for the provider to match the deployment environment
