...
function TransactionsHeader({ onBackToSummary, currentView }: { onBackToSummary: () => void, currentView: string }) {
    ...
    // Moved all cart-dependent logic inside the JSX to ensure it runs only when needed
                        ...
                        <Popover>
                         ...
                         <AlertDialogContent>
                            ...
                            <div className="py-4 space-y-4">
                                {(() => {
                                    // All cart-dependent calculations are now safely inside the dialog render prop
