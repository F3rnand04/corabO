...
export default function LoginPage() {
  ...
  // The AppLayout component is now responsible for all redirection logic if the user is already logged in.
  // We simply render the login page if there's no authenticated user.
  if (!firebaseUser) {
    return (
  ...
  // If there is a firebaseUser, AppLayout will handle the redirection.
  // Render a loader while that happens to prevent flashes of content.
  return (
      <div className="flex items-center justify-center h-screen">
        <Loader2 className="h-12 w-12 animate-spin text-primary" />
      </div>
