        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <Card className="bg-primary/5 border-primary/20">
                ...
                <CardContent className="space-y-3">
                    <p className="flex items-center gap-2"><Percent className="w-4 h-4 text-primary"/> Comisión Reducida: <span className="line-through text-muted-foreground">4.99%</span> <span className="font-bold">¡Ahora 3.99%!</span></p>
