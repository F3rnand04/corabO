...
import { MapPin, FileText, Menu, Search, LogOut, User, Wallet, History as HistoryIcon, Shield, HelpCircle, ShoppingCart, KeyRound } from "lucide-react";
...
export function Header() {
  const { cart, searchQuery, setSearchQuery, currentUser, addSearchToHistory } = useAuth();
      ...
      <div className="container px-4 sm:px-6">
        <div className="flex h-16 items-center justify-between gap-4">
          <Link href="/contacts" passHref>
             <Image 
                src={'https://i.postimg.cc/3xvTT4X8/logo-dark-png.png'} 
                alt="Corabo Logo" 
                width={120} 
                height={40} 
          ...
          <div className="flex items-center gap-1">
             <Button variant="ghost" size="icon" onClick={handleGpsToggle} onDoubleClick={() => router.push('/map')}>
