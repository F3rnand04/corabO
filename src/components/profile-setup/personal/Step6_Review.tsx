...
export default function Step6Review({ formData, onUpdate, onSubmit, isSubmitting }: Step6ReviewProps) {
  ...
  const mobilePaymentPhone = currentUser?.profileSetupData?.paymentDetails?.mobile?.mobilePaymentPhone || '';
  const initialPhoneValue = currentUser?.phone || mobilePaymentPhone;
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
             <div className="text-sm text-muted-foreground pt-2">
                ...
                <p>Tipo de Proveedor: <span className="font-semibold text-foreground">{formData.providerType}</span></p>
             </div>
             <Separator/>
